 ...
 * @author Tobias Dahlke
 */
let updateElement = function (req: Request, res: Response): void {
 ...
 * @author Tobias Dahlke
 */
let getSearch = function (req: Request, res: Response): void {
 ...
 * @author Jan Kiefer
 */
let docLineBreak = function (doc, content: String) {
 ...
 * @author Jan Kiefer
 */
let docLine = function (doc, content: String) {
    if (!content.startsWith('-?')) {
 ...
 * @author Jan Kiefer
 */
let printHeader = function (doc, header: String) {
    let options = {
        align: "center"
    };
    //Print Header
 ...
 * @author Tobias Dahlke
 */
let createContentArray = function (content: String) {
 ...
 * @author Tobias Dahlke
 */
let search = function (content: String) {
 ...
 * @author Tobias Dahlke
 */
let isItEnumeration = function (content: String) {
 ...
 * @author Tobias Dahlke
 */
let isItHeadline = function (content: String) {
    let numberEquals = 0;
    for (let i = 0; i <= content.length; i++) {
        if (content.charAt(i) === '#') {
            numberEquals++;
 ...
 * @author Tobias Dahlke
 */
let findStars = function (content: String, index, initalIndex, contentArray: Array<String>) {
 ...
 * @author Tobias Dahlke
 */
let findClosingStars = function (content: String, starNum, firstStarPos, contentArray: Array<String>) {
 ...
 */
let numberOfStars = function (content: String, starPos) {
    if (content.charAt(starPos + 1) === '*') {
